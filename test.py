...
def train(cfg): 
    # set logger
    log_dir = os.path.join(cfg.file_prefix, cfg.prefix, cfg.exp_name,"TestOnly",)
    ...
    # engine
    checkpoint_dir = os.path.join(cfg.file_prefix, cfg.prefix, cfg.exp_name, "TestOnly")
...
if __name__ == '__main__':
    ...
    parser.add_argument("--exp_name", type=str, default="DebugOnly")
    ...
    parser.add_argument("--file_prefix", type=str, default="/home/vegetabot/Filesys/Logs&Checkpoints/VI-ReID-Frame")
    ...
    cfg.cs_w = args.cs_w
    cfg.num_epoch = 0
    cfg.checkpoint = os.path.join(args.file_prefix,cfg.prefix,args.exp_name,'checkpoints',args.checkpoint)
