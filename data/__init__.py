...
from data.sampler import RandomCameraSampler
from data.sampler import RandomCameraSampler2
...
def get_train_loader(dataset, root, sample_method, batch_size, p_size, k_size, image_size, random_flip=False, random_crop=False,
    ...
    # sampler
    assert sample_method in ['random', 'identity_uniform', 'identity_random', 'norm_triplet', 'camera_random', 'camera_random2']
    ...
    elif sample_method == 'camera_random':
        batch_size = p_size * k_size
        sampler = RandomCameraSampler(train_dataset, p_size * k_size, k_size)
    elif sample_method == 'camera_random2':
        batch_size = p_size * k_size
        sampler = RandomCameraSampler2(train_dataset, p_size * k_size, k_size)
    else:
