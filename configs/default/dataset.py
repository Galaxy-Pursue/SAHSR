...
# dataset_cfg.sysu.data_root = "/root/autodl-tmp/SYSU-MM01"
# dataset_cfg.sysu.data_root = "C:/pyProject/vireid/SYSU-MM01"
dataset_cfg.sysu.data_root = "/data/lky/sysu/"

dataset_cfg.regdb = CfgNode()
dataset_cfg.regdb.num_id = 206
dataset_cfg.regdb.num_cam = 2
dataset_cfg.regdb.data_root = "/data/lky/RegDB/"
